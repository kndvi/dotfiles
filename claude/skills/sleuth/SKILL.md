...
- Once the repro test passes, confirm the debug-tag grep is empty before calling it done.
`</procedure>`
...
Full worked walkthroughs of the procedure, one per language, in [examples/](examples/):
- Java: [examples/java_null_pointer_exception.md](examples/java_null_pointer_exception.md) (NullPointerException)
- Python: [examples/python_mutable_default_argument.md](examples/python_mutable_default_argument.md) (silent data corruption from a shared mutable default argument)
- C: [examples/c_use_after_free.md](examples/c_use_after_free.md) (heap use-after-free found via AddressSanitizer)
- C++: [examples/cpp_iterator_invalidation.md](examples/cpp_iterator_invalidation.md) (invalidated iterator after `std::vector::erase`)
- JavaScript: [examples/javascript_closure_loop_variable.md](examples/javascript_closure_loop_variable.md) (closure capturing a shared `var` loop variable)
`</examples>`
