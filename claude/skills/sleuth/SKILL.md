...
- Unfamiliar with the code path involved? Follow `when_stuck`'s preventive-trace rule: use `whiteboard`'s Explore mode before generating hypotheses. Don't guess your way through code you haven't read.
