...
- Good: the design doc said the API returns JSON, but Build switched it to protobuf. Check the actual code before documenting the response format, don't trust the design doc.
- Good: repo already has a `docs/api.md`. New endpoint needs documenting there, add a section to that file instead of creating `docs/new-api.md`.
...
- Bad: writing a new doc in a style/heading format that doesn't match the rest of the repo's docs.
